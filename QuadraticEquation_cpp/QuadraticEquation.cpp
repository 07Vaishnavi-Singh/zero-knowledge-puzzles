...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 2],&signalValues[mySignalStart + 6]); // line circom 17
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_add(&expaux[1],&signalValues[mySignalStart + 7],&signalValues[mySignalStart + 8]); // line circom 19
Fr_add(&expaux[0],&expaux[1],&signalValues[mySignalStart + 4]); // line circom 19
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
